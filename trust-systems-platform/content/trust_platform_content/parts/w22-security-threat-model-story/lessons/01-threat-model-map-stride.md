---
id: w22-security-threat-model-story-d01-threat-model-map-stride
part: w22-security-threat-model-story
title: "Threat Model Map (STRIDE)"
order: 1
duration_minutes: 20
prereqs: []
proof:
...
## The Rules
- **New constraint:** Every component has explicit trust boundary + threat owner
...
## Prove it
Attach evidence for: `week-22/day1-threat-model-map.md`  
