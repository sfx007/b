...
order: 4
duration_minutes: 20
prereqs: ["w19-offline-verification-package-d03-air-gap-verification-flow"]
proof:
...
## The Rules
- **New constraint:** Verifier output includes policy mode used (`strict`/`grace`/`archival`)
...
## Prove it
Attach evidence for: `week-19/day4-time-policy-modes.md`  
